...
public class HeightMapParser {
    ...
    public HeightMapParser(String heightMapFileName) throws FileNotFoundException {
        try {
            ClassLoader classLoader = TerrainParser.class.getClassLoader();
            Optional<URL> opt = Optional.ofNullable(classLoader.getResource(heightMapFileName));
